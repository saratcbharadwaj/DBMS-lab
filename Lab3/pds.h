...
#define PDS_REPO_OPEN         101
#define PDS_REPO_CLOSED       102

// Maximum number of intex entries
...
struct PDS_RepoInfo{
	char pds_name[30];
	FILE *pds_data_fp; // FILE pointer to data file
	FILE *pds_ndx_fp;  // FILE pointer to index file 
	int repo_status; 
...
// close the files
// Name data file by appending .dat and the index file with .ndx extension
...
// pds_close
// Verify the name of repo_name with name present in repo handle
